...
# TODO - Switch to using mcu. for all imported symbols
from make_check_utils import LogsMd, TestLogInfo, \
    TestLogNameInfo, \
...
def collect_logs_and_write_unified(logs_folder,
                                   unified_log_full_file_name,
                                   description):
...
if __name__ == '__main__':
    ...
    parser.add_argument("logs_folder",
                        metavar="[logs folder name]",
                        help="log filename generated by "
                             "make_check_collect_logs")
    parser.add_argument("log_full_name",
    ...
    all_logs_info = collect_logs(mcu.cmdline_args.logs_folder)
    write_unified_logs_file(mcu.cmdline_args.logs_folder,
                            all_logs_info,
                            mcu.cmdline_args.log_full_name,
                            mcu.cmdline_args.description)

    print(f"Logs collected to {mcu.cmdline_args.log_full_name}")
